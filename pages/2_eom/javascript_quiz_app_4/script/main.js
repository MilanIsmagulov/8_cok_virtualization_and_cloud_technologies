...
let mainQuestions = [
    {
        text: 'Укажите, какой официальный сайт у проекта VirtualBox:',
        right: [1],
        type: 1,
        points: 100,
        answers: ['https://www.virtualbox.ru', 'https://www.virtualbox.org', 'https://www.virtualbox.net', 'https://www.virtualbox.com',],
    },
];
