...
// let 
const anwserArr = ['Запустить виртуальную машину с установочным образом Ubuntu', 'Нажать на кнопку «Установить Ubuntu»', 'Выбрать раскладку клавиатуры', 'Выбрать вид установки «Обычная» или «Минимальная»', 'Выбрать тип установки', 'Выбрать часовой пояс', 'Задать имя и пароль пользователя','Нажать кнопку ENTER после перезагрузки'];
...
let questionPlace = 'Установите правильную последовательность действий при установке ОС Ubuntu:';
