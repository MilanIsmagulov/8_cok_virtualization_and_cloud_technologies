...
// let 
const anwserArr = ['Запустить VirtualBox', 'Нажать кнопку создать', 'Указать имя операционной системы и выбрать установочный образ', 'Указать количество выделяемой оперативной памяти и ядер процессора', 'Указать необходимый размер виртуального жесткого диска', 'Проверить сводный итог и нажать кнопку «Готово»', ];
...
let questionPlace = 'Установите правильную последовательность действий при создании виртуальной машины:';
